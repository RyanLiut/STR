...
sys.path.insert(0, '/ssd1/liuzhu/DivCap/TMM/mycvae')
...
if __name__ == "__main__":
    g_file = "/raid/zhengf/liuzhu/SAAT_mod/output/metadata/yt2t_val_cocofmt.json"
    p_file = "/raid/zhengf/liuzhu/SAAT_mod/output/model_svo/exp_yt2t_test/test_pred.json"
    lang_stats = language_eval(g_file, p_file)
